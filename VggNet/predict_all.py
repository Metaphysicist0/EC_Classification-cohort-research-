...
def main():
    ...
    net.to(device)
    # load model weights
    model_weight_path = r"G:\EC\classification\VggNet\Vgg16.pth"  # 训练后权重的路径
    ...
    with torch.no_grad():
        ...
        plt.title('ROC curves of Vgg16', fontsize=16)
...
def plot_cfm1(cf_matrix, save_path, experiment_name):
    ...
    disp.ax_.set_title('VggNet Confusion Matrix (test)', fontsize=14)
