...
def main():
    ...
    net = densenet201(num_classes=4).to(device)

    # load model weights
    model_weight_path = r"G:\EC\classification\ResNet\weight\model201-480.pth"  # 训练后权重的路径
    ...
    with torch.no_grad():
        ...
        plt.title('ROC curves of DenseNet169', fontsize=16)
...
def plot_cfm1(cf_matrix, save_path, experiment_name):
    ...
    disp.ax_.set_title('DenseNet Confusion Matrix (test)', fontsize=14)
