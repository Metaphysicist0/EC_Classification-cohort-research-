...
def main():
    ...
    if model_weight == 1:
        model_weight_path = r'/root/autodl-tmp/classification/weight/jx_vit_base_patch16_224_in21k-e5005f0a.pth'
    ...
    epochs = 200
    best_acc = 0.0
    save_path = r'/root/autodl-tmp/classification/ResNet/weight/VIT.pth'
