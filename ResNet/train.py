...
def main():
    ...
    net = ResNet(Bottleneck, [3, 4, 23, 3], num_classes=1000)  # resnext101
    # load pretrain weights
    # download url: https://download.pytorch.org/models/resnet34-333f7ec4.pth
    model_weight_path = r'G:\\EC\\classification\\weight\\resnext101_32x8d-8ba56ff5.pth'
    ...
    epochs = 200
    best_acc = 0.0
    save_path = r'G:\EC\classification\ResNet\weight\resnet.pth'
