...
def main():
    ...
    net = ResNet(BasicBlock,[3, 4, 6, 3],1000) # resnet 34
    # load pretrain weights
    # download url: https://download.pytorch.org/models/resnet34-333f7ec4.pth
    model_weight_path = r'/root/autodl-tmp/classification/weight/resnet34-333f7ec4.pth'
    ...
    epochs = 200  # 44
    best_acc = 0.0
    save_path = r'/root/autodl-tmp/classification/ResNet/weight/resnet_{epochs}.pth'
