...
def main():
    ...
    # create model
    net = ResNet(Bottleneck, [3, 4, 23, 3], num_classes=4)   # resnet 101
    # net = ResNet(BasicBlock, [3, 4, 6, 3], num_classes=4)
    # net = ResNet(Bottleneck, [3, 4, 6, 3], num_classes=4)
    # load model weights
    model_weight_path = r'G:\EC\classification\ResNet\weight\resnet101_{150}.pth'  # 训练后权重的路径 你训练好的权重加载进来
    ...
    with torch.no_grad():
        ...
        plot_cfm1(coarse_confusion_matrix, r".\confusion_matrix", 'ResNet')
        ...
        plt.title('ROC curves of ResNet101', fontsize=16)
...
def plot_cfm1(cf_matrix, save_path, experiment_name):
    ...
    disp.ax_.set_title('ResNet Confusion Matrix (test)', fontsize=14)
